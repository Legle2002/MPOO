...
public void setAniomod(int aniomod){
  if(aniomod<0){
    System.out.println("No hay coches con anios negativos");
  }else{
    this.aniomod=aniomod;
  }
}
...
public String toString(){
  return " Coche: {"+"+marca: "+marca+", anio:"+aniomod+", color:"+color+", numero de puertas: "+numPuerta+", automatico: "+automatico+", potencia: "+potencia+"\nChofer="+chofer+" copiloto="+copiloto+" pasajero1="+pasajero1+" pasajero2="+pasajero2+"}";
}
}
